...
if ! kubectl cluster-info &> /dev/null; then
    ...
    echo "Виконайте: gcloud container clusters get-credentials YOUR_CLUSTER --zone YOUR_ZONE"
    exit 1
fi
...
echo ""
echo "Логи:"
echo "  kubectl logs -f deployment/auth -n cloud-demo"
echo "  kubectl logs -f deployment/user -n cloud-demo"
